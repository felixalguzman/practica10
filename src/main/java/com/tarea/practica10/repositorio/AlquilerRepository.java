...
import com.tarea.practica10.servicios.ReporteAlquiler;
...
public interface AlquilerRepository extends JpaRepository<Alquiler, Long> {
    ...
    @Query(value = "select c.ID as cliente, sum(cantidad_equipos) as cantidad from Alquiler a, Cliente c where a.CLIENTE_ID = c.ID group by c.ID", nativeQuery = true)
