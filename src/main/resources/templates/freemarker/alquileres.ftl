                ...
                <div class="col-xs-12">
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            ...
                            <br>
                            <table id="alquiler" class="display" style="width:100%">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="cliente" style="width: 100%" class="form-control" id="cliente" required>
                        </div>

                        <div class="form-group">
                            <label for="fechaEntrega">Fecha Entrega</label>
                            <input type="date" name="fechaEntrega" class="form-control" id="fechaEntrega" required>
                        </div>

                        <div class="form-group">
                            <label for="equipos">Equipos</label>
                            <select name="equipos" style="width: 100%" id="equipos" multiple="multiple" required>
                        </div>
...
<script>
    ...
    function format(state) {
        ...
        return '<span><img class="flag" style="padding-right: 10px;max-width: 24px;" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/4579/NASA_meatball.png" / >' + state.text; + '<span>'
    }
    ...
    function actualizarTabla() {
        ...
        let tabla = $('#tabla').DataTable({
            ...
            columns: [
                ...
                {targets: 2, data: 'tarifa'},
                {targets: 3, data: 'familia'},
                {targets: 4, data: 'subFamilia'},
