...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="webjars/AdminLTE/2.4.3/dist/css/AdminLTE.css">
    <!-- iCheck -->
    <link rel="stylesheet" href="webjars/AdminLTE/2.4.3/plugins/iCheck/all.css">
...
<div class="login-box">
    <div class="login-logo">
        <a href="../../index2.html"><b>Alquileres</b></a>
    </div>
    <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="webjars/AdminLTE/2.4.3/plugins/iCheck/icheck.min.js"></script>
<script>
    $(function () {
        $('input').iCheck({
